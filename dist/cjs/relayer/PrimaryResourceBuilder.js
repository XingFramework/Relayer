...
var PrimaryResourceBuilder = (function (_Constructable) {
  function PrimaryResourceBuilder(response, ResourceClass) {
    _classCallCheck(this, PrimaryResourceBuilder);

    _get(Object.getPrototypeOf(PrimaryResourceBuilder.prototype), "constructor", this).call(this);
    this.response = response;
    this.ResourceClass = ResourceClass;
  }

  _inherits(PrimaryResourceBuilder, _Constructable);
