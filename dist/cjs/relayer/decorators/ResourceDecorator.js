...
var ResourceDecorator = (function (_Constructable) {
  function ResourceDecorator(name) {
    _classCallCheck(this, ResourceDecorator);

    _get(Object.getPrototypeOf(ResourceDecorator.prototype), 'constructor', this).call(this);
    this.name = name;
  }

  _inherits(ResourceDecorator, _Constructable);
